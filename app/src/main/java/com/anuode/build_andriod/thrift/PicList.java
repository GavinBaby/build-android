...
public class PicList implements org.apache.thrift.TBase<PicList, PicList._Fields>, java.io.Serializable, Cloneable, Comparable<PicList> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PicList");
  ...
  static {
    schemes.put(StandardScheme.class, new PicListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PicListTupleSchemeFactory());
  }

  public List<Pic> data; // required
  /**
   * 数据总数
   */
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PicList.class, metaDataMap);
  }
   ...
   */
  public PicList(PicList other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.isSetData()) {
      List<Pic> __this__data = new ArrayList<Pic>(other.data.size());
      for (Pic other_element : other.data) {
        __this__data.add(new Pic(other_element));
      }
  ...
  public java.util.Iterator<Pic> getDataIterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void addToData(Pic elem) {
    if (this.data == null) {
  ...
  public PicList setData(List<Pic> data) {
    this.data = data;
    return this;
  }
   ...
   * 数据总数
   */
  public PicList setTotalSize(int totalSize) {
    this.totalSize = totalSize;
    setTotalSizeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PicList)
      return this.equals((PicList)that);
    return false;
  }

  public boolean equals(PicList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(PicList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PicList(");
    boolean first = true;
  ...
  private static class PicListStandardSchemeFactory implements SchemeFactory {
    public PicListStandardScheme getScheme() {
      return new PicListStandardScheme();
    }
  }

  private static class PicListStandardScheme extends StandardScheme<PicList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PicList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data = new ArrayList<Pic>(_list48.size);
                Pic _elem49;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PicList struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PicListTupleSchemeFactory implements SchemeFactory {
    public PicListTupleScheme getScheme() {
      return new PicListTupleScheme();
    }
  }

  private static class PicListTupleScheme extends TupleScheme<PicList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PicList struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PicList struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(2);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list53 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.data = new ArrayList<Pic>(_list53.size);
          Pic _elem54;
